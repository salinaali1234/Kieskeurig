...
public class DutchElectionProcessorDemo {
    ...
    public static void main(String[] args) throws IOException, XMLStreamException {
        ...
        DutchElectionTransformerForParties creator = new DutchElectionTransformerForParties();

        // And the election processor that traverses the folders and processes the XML-files.
        DutchElectionProcessor<ElectionForParty> electionProcessor = new DutchElectionProcessor<>(creator);
        ...
        ElectionForParty election = electionProcessor.processResults("TK2023", PathUtils.getResourcePath("/EML_bestanden_TK2023_HvA_UvA"));
